...
import { BACKGROUND_NETFLIX_IMAGE, USER_AVATAR } from "../utils/constant";
  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img src={BACKGROUND_NETFLIX_IMAGE} alt="logo" className="h-screen object-cover w-screen" />
      </div>
      <form
        className="w-full md:w-3/12 absolute p-12 bg-black mt-10 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80"
